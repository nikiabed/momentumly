...
export const Summary = () => {
  ...
  return (
    <div className="bg-background rounded-3xl shadow p-6 flex-1">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-foreground/10 rounded-2xl p-5 text-center">
          <div className="text-center font-semibold">
            ...
            <h2 className="text-muted text-sm ">از 30 روز</h2>
          </div>
        </div>
        ...
        <div className="bg-foreground/10 rounded-2xl p-5 flex items-center gap-3">
          ...
          <div className="text-center font-semibold">
            <h2 className="text-muted text-sm">تسک های انجام شده</h2>
